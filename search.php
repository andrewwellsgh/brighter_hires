    ...
    <body>
       ...
       ?>
        ...
        <div id="search_results_container">
            ...
            <!-- Loads in the search results by providing the Divs for Javascript to write in to -->
            <?php //File is contained in functions_js.php, use control f and look for search.php code ?>
        <div id="loaderContainer2">  
         <!-- Removed because search results appeared without it 
         <div id="loader"> 
         </div>
        -->
        </div>
